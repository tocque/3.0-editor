...
////// 初始化 //////
core.prototype.init = async function (coreData) {
    this._forwardFuncs();
    ...
    await core.loader._load(coreData.loadList);
    core.material.images = core.images; // 保持兼容
    core.icons.initMetadata();
    core.sprite._load();
    core.scenes._load();
    // await core.extensions._load();
    core._afterLoadResources();
}
