...
maps.prototype._init = function () {
    this.blocksInfo = main.gameData.maps;
    //delete(main.gameData.maps);
}
...
maps.prototype.generateGroundPattern = function (floorId) {
    ...
    core.drawIcon(core.material.groundCanvas, groundId, 0, 0);
...
////// 为autotile判定边界 ////// 
maps.prototype._makeAutotileEdges = function (autotileIds, autotiles) {
    ...
    autotileIds.forEach(function (t) {
        ...
        ctx.drawImage(autotiles[t], 0, 0, 32, 32, 0, 0, 32, 32);
        ...
        autotileIds.forEach(function (t2) {
            ...
            ctx.clearRect(0, 0, 32, 32);
            ctx.drawImage(autotiles[t2], 32, 0, 32, 32, 0, 0, 32, 32);
