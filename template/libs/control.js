...
control.prototype.createStartPanel = function () {
    core.dom.startLogo.innerText = core.firstData.title;
    
    core.dom.startBackground.src = core.images.images[main.startBackground].src;
    core.dom.startLogo.style=main.startLogoStyle;

    main.dom.startButtonGroup.style = main.startButtonsStyle;
    main.levelChoose.forEach(([label, value]) => {
...
control.prototype._syncSave_http = function (type, saves) {
    ...
    axios.post("/games/sync.php", formData).then(function (res) {
...
control.prototype.getSaves = function (ids, callback) {
    if (!Array.isArray(ids)) return this.getSave(ids, callback);
