...
items.prototype._init = function () {
    this.items = main.gameData.items.items;
    this.itemEffect = main.gameData.items.itemEffect;
    this.itemEffectTip = main.gameData.items.itemEffectTip;
    this.useItemEffect = main.gameData.items.useItemEffect;
    this.canUseItemEffect = main.gameData.items.canUseItemEffect;
    if (!main.gameData.items.equipCondition)
        main.gameData.items.equipCondition = {};
    this.equipCondition = main.gameData.items.equipCondition;
}
