const core = new class core {
     ...
     * @param {String} name 属性名称, 如hp, atk, def, mdef, money, experience
     * @param value 属性的值
     */
     ...
     * @param {'x'|'y'|'direction'} name 要设置的坐标属性
    ...
    /**
     * 设置某个物品的个数
     * @example core.setItem('pickaxe', 10) // 将破墙镐个数设置为10个
     * @param {String} itemId 物品ID
     * @param {Number} itemNum 物品数量 
     */
    setItem(itemId, itemNum) {}
    
    /**
     * 增加某个物品的个数 不会更新游戏画面或是显示提示
     * @example core.addItem('pickaxe', 2) // 将破墙镐的个数增加2个
     * @param {String} itemId 物品ID
     * @param {Number} itemNum 物品数量 
     */
    ...
    /**
     * 获得某个物品 会更新游戏画面, 在左上角显示提示
     * @example core.getItem('pickaxe', 4) // 令勇士获得4个破墙镐
     * @param {String} itemId 物品ID
     * @param {Number} itemNum 物品数量 
     */
    ...
    /**
     * 删除某个物品
     * @example core.removeItem('pickaxe', 3) // 删除3个破墙镐
     * @param {String} itemId 物品ID
    ...
    /**
     * 持有某个物品的数量
     * @example core.itemCount('pickaxe') // 返回当前破墙镐的个数
     * @param {String} itemId 物品ID
     * @returns {Number} 物品数量
     */
    itemCount(itemId) {}
    ...
    /**
     * 是否持有某个物品
     * @example core.hasItem('pickaxe') // 是否有破墙稿
     * @param {String} itemId 物品ID
     * @returns {Boolean}
     */
    itemCount(itemId) {}
    ...
    /**
     * 获得某个装备位的当前装备
     * @example core.getEquip(0) // 获得0号装备类型（武器）的当前装备的itemId
     * @param {Number} equipType 装备位编号, 和全塔属性中的equipName对应
     * @returns {Number||null} 装备的itemId
     */
    getEquip(equipType) {}

    /**
     * 查询当前某个具体的装备是否处于正在被装备状态。
     * @example core.hasEquip('sword1') // 是否装备了铁剑
     * @param {String} itemId 装备位编号, 和全塔属性中的equipName对应
    ...
    ui = new class ui {
         ...
         * 可以是系统画布之一，也可以是任意自定义动态创建的画布名 画布名称或者画布的context
         * @param {String|HTMLImageElement|CanvasRenderingContext2D} image 
         * @param {*} x 
         * @param {*} y 
         * @param {*} w 
         * @param {*} h 
         ...
         * @param {*} h1 
         */
        drawImage(name, image, x, y, w, h, x1, y1, w1, h1) {}
    }

    drawImage = this.ui.drawImage
}
